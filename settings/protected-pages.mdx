...
description: "Choose which pages on your Framer site require authentication, using regex patterns so the Shield Script auto-redirects guests to your sign-in page."
icon: "shield"
---
