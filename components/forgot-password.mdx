...
description: "Forgot password form for Framer that collects the user's email, sends a secure reset link, and is rate-limited to prevent abuse of the reset flow."
icon: "key"
---
