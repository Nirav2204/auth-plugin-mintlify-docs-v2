---
title: "Magic Link"
description: "Passwordless magic link component for Framer that emails users a one-time sign-in link so they can authenticate with a single click, no password."
